...
import { Tag, Rocket, MapPin, Flag, Calendar, Plus, AlertTriangle, Activity, CloudLightning, Anchor, Search, CloudSun, Wind, Key } from 'lucide-react';
    ...
    <div style={{ 
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'space-between', height: '100%' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
          ...
          {/* Section A: Integrated Port Congestion, Vessel ETA & Open-Meteo Forecast API Box */}
