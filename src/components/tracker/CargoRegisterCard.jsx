      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          <div className="form-group" style={{ marginBottom: 0 }}>
            <label className="form-label" style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', color: '#334155', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.3rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ background: '#fffbe6', border: '1px solid #fef08a', borderRadius: 'var(--radius-md)', padding: '0.85rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
              ...
              <span className="badge" style={{ background: '#fef3c7', color: '#d97706', fontSize: '0.7rem', padding: '0.15rem 0.45rem' }}>
                AI 분석 완료
              </span>
            </div>

            <div style={{ background: '#ffffff', border: '1px solid #fde68a', borderRadius: 'var(--radius-sm)', padding: '0.65rem 0.75rem' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#92400e', marginBottom: '0.35rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                  <Activity className="w-3.5 h-3.5 text-amber-600" />
                  실시간 항만 정체 & ETA 지연 분석 (API 연동)
                </div>
                <div style={{ fontSize: '0.65rem', color: '#0369a1', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.2rem' }}>
                  <Key className="w-3 h-3" /> Marine Key
                </div>
              </div>

              {/* Port Congestion % & Vessel Real-Time ETA */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem', fontSize: '0.75rem', color: '#334155' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                    <Anchor className="w-3.5 h-3.5 text-blue-600" /> 1. 항만 입항 정체 (Port Congestion)
                  </span>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                    <Calendar className="w-3.5 h-3.5 text-rose-600" /> 2. 정체 반영 Vessel ETA
                  </span>
                  <strong style={{ color: '#e11d48' }}>{vesselRealtimeEta}</strong>
                </div>

                {/* Open-Meteo Free Forecast API Live Weather Data */}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '0.25rem', marginTop: '0.25rem', borderTop: '1px dashed #fef08a' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#0284c7', fontWeight: 700 }}>
                    <CloudSun className="w-3.5 h-3.5 text-sky-600" /> Open-Meteo ({destCityName} 날씨):
                  </span>
                  <strong style={{ color: '#0369a1', fontSize: '0.72rem' }}>
              ...
              <div style={{ marginTop: '0.45rem', paddingTop: '0.35rem', borderTop: '1px solid #fef08a', fontSize: '0.72rem', color: '#78350f', lineHeight: 1.3 }}>
        ...
        {/* Section D: Save Button with 40px top spacing */}
